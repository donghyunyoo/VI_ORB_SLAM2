...
public:
    ...
    vector<Frame,Eigen::aligned_allocator<Frame>> mv20FramesReloc;  // to remove eigen error!
    ...
    cv::Mat GrabImageRGBDVI(const cv::Mat &imRGB, const cv::Mat &imD, const std::vector<IMUData> &vimu, const double &timestamp);
